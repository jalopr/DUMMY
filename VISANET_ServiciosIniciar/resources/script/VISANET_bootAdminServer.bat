...
@ECHO %vTRANSACCION% EJECUTANDO COMANDO 'Servicio' [CINEMAX_bootAdminServer-1.0.jar] ...
C:\java\JDK\jdk1.8.0_9\bin\java -jar C:\WORKSPACE_Eclipse\VISANET_PROPUESTA\VISANET_ServiciosIniciar\resources\jars\VISANET_bootAdminServer-1.0.jar  
