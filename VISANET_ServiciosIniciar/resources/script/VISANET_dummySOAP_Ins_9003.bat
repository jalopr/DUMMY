...
@ECHO %vTRANSACCION% EJECUTANDO COMANDO 'Servicio' [VISANET_dummySOAP-1.0.jar] ...
C:\java\JDK\jdk1.8.0_9\bin\java -jar -Dserver.port=9003 C:\WORKSPACE_Eclipse\VISANET_PROPUESTA\VISANET_ServiciosIniciar\resources\jars\VISANET_dummySOAP-1.0.jar    
