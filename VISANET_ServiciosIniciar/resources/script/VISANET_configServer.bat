...
@ECHO %vTRANSACCION% EJECUTANDO COMANDO 'Servicio' [CINEMAX_configServer-1.0.jar] ...
C:\java\JDK\jdk1.8.0_9\bin\java -jar C:\WORKSPACE_Eclipse\VISANET_PROPUESTA\VISANET_ServiciosIniciar\resources\jars\VISANET_configServer-1.0.jar   
